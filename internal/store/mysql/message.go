...
func (store *MySQLStore) SaveMessage(msg *chat.Message) error {
...
func (store *MySQLStore) saveArtifactData(data []*artifacts.ArtifactData) error {
...
func (store *MySQLStore) GetMessage(id string) (*chat.Message, error) {
...
func (store *MySQLStore) populateArtifacts(messages []*chat.Message) ([]*chat.Message, error) {
...
func (store *MySQLStore) DeleteMessage(id string) error {
...
func (store *MySQLStore) ListMessages(filter store.Filter) ([]*chat.Message, error) {
...
func (store *MySQLStore) GetConversation(conversation string) (*chat.Conversation, error) {
...
func (store *MySQLStore) DeleteConversation(conversation string) error {
...
func (db *MySQLStore) ListConversations(filter store.Filter) ([]*chat.Conversation, error) {
...
func (store *MySQLStore) ListConversations2(filter store.Filter) ([]*chat.Conversation, error) {
...
func (store *MySQLStore) GetLatestConversation(agent string, user string) (string, time.Time, error) {
	query := `SELECT
		conversation,
...
func (store *MySQLStore) sqlToMessages(rows *sql.Rows) ([]*chat.Message, error) {
	defer rows.Close()
...
func (store *MySQLStore) sqlToArtifacts(rows *sql.Rows) ([]artifacts.ArtifactData, error) {
	defer rows.Close()
