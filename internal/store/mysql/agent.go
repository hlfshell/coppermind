...
func (store *MySQLStore) SaveAgent(agent *agents.Agent) error {
...
func (store *MySQLStore) GetAgent(id string) (*agents.Agent, error) {
...
func (store *MySQLStore) DeleteAgent(id string) error {
...
func (store *MySQLStore) ListAgents() ([]*agents.Agent, error) {
